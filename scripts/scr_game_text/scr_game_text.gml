...
function scr_game_text(_text_id){
    ...
    scr_text(scr_loc("Hola, soy Maya y este es mi dialogo con retrato."), c_white, spr_noelle_normal, snd_txtmaya);
    scr_text(scr_loc("Este segundo renglon tambien se acomoda solito respetando la cabeza."), c_white, spr_noelle_normal, snd_txtmaya);
