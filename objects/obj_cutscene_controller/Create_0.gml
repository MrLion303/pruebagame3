...
cutscene_camera = view_camera[0];
camera_valid = (cutscene_camera != -1);

camera_origin_x = 0;
camera_origin_y = 0;
camera_original_target = noone;
...
if (camera_valid)
{
    camera_origin_x = camera_get_view_x(cutscene_camera);
    camera_origin_y = camera_get_view_y(cutscene_camera);
