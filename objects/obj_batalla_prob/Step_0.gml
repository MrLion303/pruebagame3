if (esta_activo) {
    ...
    if (_p != noone) {
        ...
        if (!instance_exists(obj_transicion_bbs)) {
            ...
            // --- PROBABILIDAD DEL 25% ---
            // random(1) devuelve un decimal entre 0 y 1. Un valor menor a 0.25 equivale al 25%.
            if (random(1) < 0.25) {
                ...
                // --- SI NO SE CUMPLE EL 25% ---
                // Desactivamos el objeto temporalmente por 60 frames (1 segundo) 
                // para evitar que el chequeo se ejecute 60 veces por segundo si te quedas pegado al enemigo.
                esta_activo = false;
                alarm[0] = 60; 
            }
        }
